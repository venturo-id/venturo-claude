...
3) If installation fails: display the error and suggest manual steps to fix.
4) After installation complete, close the session with "Installasi telah berhasil, silahkan restart claude untuk mendapatkan konfigurasi terbaru."